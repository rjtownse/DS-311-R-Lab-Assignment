...
\FunctionTok{print}\NormalTok{(}\FunctionTok{typeof}\NormalTok{(a))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{typeof}\NormalTok{(b))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{typeof}\NormalTok{(c))}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Enter your code here!}
\FunctionTok{print}\NormalTok{(}\FunctionTok{typeof}\NormalTok{(d))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(LETTERS[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{13}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
